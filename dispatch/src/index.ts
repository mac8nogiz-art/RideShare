...
//             return {
//                 status: "healthy", redis: "connected", matcher: stats, timestamp: new Date().toISOString()
//             };
//         } catch (err) {
...
//
//         // Start matcher
//         logger.info('Starting real-time matcher...');
//         realTimeMatcherService.start();
